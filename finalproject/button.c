...
//	#warning "Unimplemented function: void button_init()"
	...
	// set bits 7-4 to output and 3-0 to input
	GPIO_PORTE_DIR_R &= 0xF0;
	// bits 0-3 are enabled for digital functionality
...
uint8_t button_getButton() {
	...
	//
	// Bitwise AND:
	// (GPIO_PORTE_DATA_R & 0b0000 0001) => 0b0000 0000 if Sw3 is pushed
    ...
    int button = 0;
    // if the expression is 0, the button is pressed
